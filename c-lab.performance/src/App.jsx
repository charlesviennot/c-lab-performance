...
\
// ==================================================================================\
// \uc0\u55357 \u56391 \u55357 \u56391 \u55357 \u56391  ZONE DE CONFIGURATION UTILISATEUR \u55357 \u56391 \u55357 \u56391 \u55357 \u56391 \
//\
...
//\
// \uc0\u55357 \u56390 \u55357 \u56390 \u55357 \u56390  FIN DE LA ZONE DE CONFIGURATION \u55357 \u56390 \u55357 \u56390 \u55357 \u56390 \
// ==================================================================================\
\
// --- DATA : PROTOCOLES RUNNING ---\
const RUN_PROTOCOLS = \{\
  steady: [\
    \{ name: "Mise en action", sets: "10 min", reps: "Continu", rest: "-", rpe: 2, note: "Progressif", imageKeyword: "jogging", instructions: "Commencez tr\'e8s lentement. Laissez le corps monter en temp\'e9rature. Respiration par le nez recommand\'e9e." \},\
    \{ name: "Corps de s\'e9ance", sets: "30-40 min", reps: "Continu", rest: "-", rpe: 3, note: "Zone 2", imageKeyword: "running", instructions: "Allure de croisi\'e8re. Vous devez pouvoir tenir une conversation compl\'e8te sans essoufflement." \},\
    \{ name: "Lignes Droites (Option)", sets: "5", reps: "80m", rest: "Retour march\'e9", rpe: 6, note: "Technique", imageKeyword: "sprint track", instructions: "Acc\'e9l\'e9ration progressive sur 80m. Focus sur la pose de pied et le redressement. Ce n'est pas un sprint max." \}\
  ],\
  interval_short: [\
    \{ name: "\'c9chauffement Complet", sets: "20 min", reps: "Continu", rest: "-", rpe: 3, note: "Pr\'e9paration", imageKeyword: "stretching run", instructions: "15' footing lent + 5' de gammes (talons-fesses, mont\'e9es de genoux, pas chass\'e9s) pour activer l'\'e9lasticit\'e9." \},\
    \{ name: "Fractions 30/30", sets: "2 blocs", reps: "8-10 reps", rest: "2' entre blocs", rpe: 8, note: "VMA", imageKeyword: "track running", instructions: "30 sec vite (dynamique) / 30 sec trot lent. Ne partez pas au sprint, visez la r\'e9gularit\'e9." \},\
    \{ name: "Retour au calme", sets: "10 min", reps: "Lent", rest: "-", rpe: 2, note: "Lactate clearance", imageKeyword: "cooling down", instructions: "Trot tr\'e8s lent pour faire redescendre la fr\'e9quence cardiaque et rincer les muscles." \}\
  ],\
  threshold: [\
    \{ name: "\'c9chauffement", sets: "20 min", reps: "Continu", rest: "-", rpe: 3, note: "A\'e9robie", imageKeyword: "road running", instructions: "Footing progressif. Finir par 2-3 acc\'e9l\'e9rations sur 20 secondes pour monter le cardio." \},\
    \{ name: "Blocs au Seuil", sets: "3", reps: "8 \'e0 10 min", rest: "2 min trot", rpe: 7, note: "Seuil Ana\'e9robie", imageKeyword: "fast run", instructions: "Allure 'confortablement difficile'. On ne peut plus parler, mais on ne souffre pas. Concentration sur le souffle." \},\
    \{ name: "Retour au calme", sets: "10 min", reps: "Lent", rest: "-", rpe: 2, note: "R\'e9cup\'e9ration", imageKeyword: "sunset run", instructions: "Rel\'e2chez totalement les \'e9paules et les bras." \}\
  ],\
  hills: [\
    \{ name: "\'c9chauffement", sets: "20 min", reps: "Continu", rest: "-", rpe: 3, note: "Pr\'e9paration", imageKeyword: "trail running", instructions: "Footing sur terrain plat avant d'attaquer la pente." \},\
    \{ name: "Cote courtes", sets: "8-10", reps: "30-45 sec", rest: "Descente march\'e9e", rpe: 9, note: "Puissance", imageKeyword: "uphill run", instructions: "Montez dynamique. Poussez fort sur les orteils, levez les genoux, aidez-vous des bras. R\'e9cup\'e9rez en descendant." \},\
    \{ name: "Retour au calme", sets: "10 min", reps: "Lent", rest: "-", rpe: 2, note: "Cool down", imageKeyword: "forest run", instructions: "Sur le plat pour d\'e9rouler les jambes." \}\
  ],\
  long_run: [\
    \{ name: "Premi\'e8re partie", sets: "1/3 temps", reps: "Lent", rest: "-", rpe: 3, note: "\'c9conomie", imageKeyword: "long run", instructions: "D\'e9part tr\'e8s prudent. \'c9conomisez le glycog\'e8ne. Hydratez-vous d\'e8s les 20 premi\'e8res minutes." \},\
    \{ name: "C\'9cur de sortie", sets: "1/3 temps", reps: "Allure Endurance", rest: "-", rpe: 4, note: "Volume", imageKeyword: "marathon training", instructions: "Allure cible endurance. Fluidit\'e9, rel\'e2chement. Visualisez la course." \},\
    \{ name: "Fin de sortie", sets: "1/3 temps", reps: "Libre", rest: "-", rpe: 5, note: "Mental", imageKeyword: "tired runner", instructions: "Si vous vous sentez bien, acc\'e9l\'e9rez l\'e9g\'e8rement (progressive finish). Sinon, maintenez l'allure." \}\
  ],\
  recovery: [\
    \{ name: "Footing", sets: "30-45 min", reps: "Continu", rest: "-", rpe: 2, note: "R\'e9cup\'e9ration", imageKeyword: "jogging morning", instructions: "Aucun objectif d'allure. Courez 'au feeling', tr\'e8s lentement. C'est un massage pour les jambes." \}\
  ]\
\};\
\
// --- DATA : BIBLIOTH\'c8QUE MUSCU ---\
const STRENGTH_PROTOCOLS = \{\
  force: \{\
    legs: [\
      \{ name: "Back Squat", sets: 5, reps: "3-5", rest: "3-4 min", rpe: 9, note: "Explosif \'e0 la mont\'e9e", imageKeyword: "squat", instructions: "Barre sur les trap\'e8zes, pieds largeur \'e9paules. Descendez fesses en arri\'e8re jusqu'\'e0 la parall\'e8le. Gardez le dos droit et gain\'e9. Poussez fort dans les talons pour remonter.", \
        imageUrl: "" \}, \
      \{ name: "Deadlift", sets: 3, reps: "5", rest: "3 min", rpe: 8, note: "Cha\'eene post.", imageKeyword: "deadlift", instructions: "Barre au sol contre les tibias. Dos plat, poitrine sortie. Poussez le sol avec les jambes avant de tirer avec le dos. Extension compl\'e8te de hanche en haut.", \
        imageUrl: "" \},\
      \{ name: "Fentes Arri\'e8re (Lourd)", sets: 3, reps: "6/jambe", rest: "2 min", rpe: 8, note: "Stabilit\'e9.", imageKeyword: "lunge", instructions: "Un grand pas en arri\'e8re. Descendez le genou arri\'e8re proche du sol. Gardez le buste droit. Poussez avec la jambe avant pour revenir.", \
        imageUrl: "" \},\
      \{ name: "Box Jumps", sets: 5, reps: "3", rest: "2 min", rpe: 10, note: "Explosivit\'e9.", imageKeyword: "boxjump", instructions: "Saut explosif sur une boite (~60cm). Atterrissez en douceur, genoux fl\'e9chis. Extension compl\'e8te des hanches en l'air.", \
        imageUrl: "" \}\
    ],\
    upper: [\
      \{ name: "Weighted Pull-ups", sets: 5, reps: "5", rest: "3 min", rpe: 9, note: "Lest\'e9.", imageKeyword: "pullup", instructions: "Tractions prise pronation. Menton au-dessus de la barre. Contr\'f4lez la descente. Ajoutez du poids si > 8 reps faciles.", \
        imageUrl: "" \},\
      \{ name: "Military Press", sets: 5, reps: "5", rest: "3 min", rpe: 8, note: "Force \'e9paules.", imageKeyword: "shoulder press", instructions: "Debout, barre sur les clavicules. D\'e9veloppez au-dessus de la t\'eate sans cambrer le dos (gainage fort). Verrouillez les coudes.", \
        imageUrl: "" \},\
      \{ name: "Pendlay Row", sets: 4, reps: "6", rest: "2 min", rpe: 8, note: "Explosif.", imageKeyword: "barbell row", instructions: "Buste parall\'e8le au sol. Tirez la barre explosivement vers le bas de la poitrine. Reposez la barre au sol \'e0 chaque rep.", \
        imageUrl: "" \},\
      \{ name: "Core Hold (Lest\'e9)", sets: 4, reps: "30s", rest: "90s", rpe: 8, note: "Gainage.", imageKeyword: "plank", instructions: "Planche abdominale avec un disque sur le dos. Corps align\'e9, fessiers serr\'e9s. Ne laissez pas le bassin tomber.", \
        imageUrl: "" \}\
    ],\
    full: [\
      \{ name: "Trap Bar Deadlift", sets: 5, reps: "5", rest: "3 min", rpe: 9, note: "Force globale.", imageKeyword: "deadlift", instructions: "Variante plus s\'fbre du deadlift. Poussez dans les jambes comme un squat invers\'e9. Gardez les bras tendus.", \
        imageUrl: "" \},\
      \{ name: "Bench Press", sets: 5, reps: "5", rest: "3 min", rpe: 9, note: "Pouss\'e9e.", imageKeyword: "bench press", instructions: "Dos plat sur le banc, pieds ancr\'e9s au sol. Descendez la barre milieu de poitrine. Poussez explosivement.", \
        imageUrl: "" \},\
      \{ name: "Weighted Squat", sets: 4, reps: "6", rest: "3 min", rpe: 8, note: "Jambes.", imageKeyword: "squat", instructions: "Voir Back Squat.", \
        imageUrl: "" \},\
      \{ name: "Farmers Walk", sets: 3, reps: "20m", rest: "2 min", rpe: 9, note: "Grip & Core.", imageKeyword: "gym", instructions: "Marchez avec deux halt\'e8res tr\'e8s lourds. Posture parfaite, \'e9paules en arri\'e8re. Ne pas dandiner.", \
        imageUrl: "" \}\
    ]\
  \},\
  hypertrophy: \{\
    push: [ \
      \{ name: "D\'e9velopp\'e9 Couch\'e9 Halt\'e8res", sets: 4, reps: "10-12", rest: "90s", rpe: 8, note: "Amplitude max.", imageKeyword: "bench press dumbbells", instructions: "Plus d'amplitude qu'\'e0 la barre. Bien \'e9tirer les pecs en bas. Resserrer en haut sans claquer les halt\'e8res.", \
        imageUrl: "https://i.postimg.cc/pLfpNd9Q/De-veloppe-Couche-Halte-res.png" \},\
      \{ name: "D\'e9velopp\'e9 Militaire", sets: 4, reps: "12", rest: "90s", rpe: 8, note: "Contr\'f4le.", imageKeyword: "shoulder press", instructions: "Assis ou debout. Contr\'f4lez la descente (3 sec) pour maximiser le temps sous tension.", \
        imageUrl: "https://i.postimg.cc/T1vJpxSR/dev_militaire.png" \},\
      \{ name: "Dips", sets: 3, reps: "Max", rest: "60s", rpe: 9, note: "Finisher.", imageKeyword: "dips", instructions: "Penchez-vous en avant pour cibler les pecs. Descendez jusqu'\'e0 ce que les \'e9paules soient sous les coudes.", \
        imageUrl: "https://i.postimg.cc/cCGBrWjx/dips.png" \},\
      \{ name: "\'c9l\'e9vations Lat\'e9rales", sets: 4, reps: "15-20", rest: "45s", rpe: 9, note: "Faisceau Lat\'e9ral.", imageKeyword: "gym workout", instructions: "Bras l\'e9g\'e8rement fl\'e9chis. Montez les coudes, pas les mains. Imaginez verser une carafe d'eau en haut.", \
        imageUrl: "https://i.postimg.cc/Xq6kpWh7/elevation_late_rale.png" \},\
      \{ name: "Extensions Triceps Poulie", sets: 4, reps: "15", rest: "45s", rpe: 9, note: "Isolation.", imageKeyword: "triceps", instructions: "Coudes coll\'e9s au corps. Seuls les avant-bras bougent. Contractez fort en bas.", \
        imageUrl: "https://i.postimg.cc/prQYj7bn/Extensions_Triceps_Poulie.png" \},\
      \{ name: "\'c9cart\'e9 Poulie Vis-\'e0-vis", sets: 3, reps: "15-20", rest: "45s", rpe: 9, note: "Finition Pecs.", imageKeyword: "cable crossover", instructions: "Cherchez la contraction maximale en croisant les mains. Gardez les coudes ouverts.", \
    ...
    pull: [\
      ...
      \{ name: "Rowing Barre", sets: 4, reps: "10", rest: "90s", rpe: 8, note: "\'c9paisseur.", imageKeyword: "rowing", instructions: "Buste pench\'e9 \'e0 45\'b0. Tirez vers le nombril en resserrant les omoplates.", \
        imageUrl: "https://i.postimg.cc/3xcVSyVw/rowing.png" \},\
      \{ name: "Face Pulls", sets: 4, reps: "15", rest: "60s", rpe: 7, note: "Sant\'e9 \'e9paules.", imageKeyword: "gym facepull", instructions: "Corde \'e0 la poulie haute. Tirez vers le visage en \'e9cartant les mains. Cible l'arri\'e8re d'\'e9paule.", \
      ...
      \{ name: "Hammer Curls", sets: 3, reps: "12", rest: "60s", rpe: 9, note: "Brachial.", imageKeyword: "hammer curl", instructions: "Prise marteau (neutre). Cible l'\'e9paisseur du bras et l'avant-bras.", \
    ...
    legs: [ \
      \{ name: "Squat", sets: 4, reps: "10-12", rest: "3 min", rpe: 8, note: "Base jambes.", imageKeyword: "squat", instructions: "Amplitude compl\'e8te. Le creux de la hanche doit passer sous le genou si la mobilit\'e9 le permet.", \
        imageUrl: "https://i.postimg.cc/ry7vNRBY/squat.png" \},\
      \{ name: "Presse \'e0 cuisses", sets: 4, reps: "12-15", rest: "2 min", rpe: 9, note: "Volume.", imageKeyword: "leg press", instructions: "Pieds largeur \'e9paules. Descendez genoux vers \'e9paules. Ne verrouillez pas les genoux en haut.", \
        imageUrl: "https://i.postimg.cc/tgD5S8YP/legs_press.png" \},\
      \{ name: "Fentes March\'e9es", sets: 3, reps: "12/jambe", rest: "90s", rpe: 8, note: "Unilat\'e9ral.", imageKeyword: "lunges", instructions: "Faites des pas de g\'e9ant. Le genou arri\'e8re fr\'f4le le sol. Gardez le rythme.", \
        imageUrl: "https://i.postimg.cc/FKGZWw7S/fente_marche.png" \},\
      \{ name: "Leg Curl", sets: 4, reps: "15", rest: "60s", rpe: 9, note: "Ischios.", imageKeyword: "leg curl", instructions: "Contr\'f4lez la phase retour (excentrique). Ne d\'e9collez pas les hanches du banc.", \
        imageUrl: "https://i.postimg.cc/6Qz0jFyn/Legs_curl.png" \},\
      \{ name: "Leg Extension", sets: 3, reps: "20", rest: "45s", rpe: 10, note: "Finition Quads.", imageKeyword: "leg extension", instructions: "Contr\'f4lez la descente. Br\'fblure garantie.", \
    ...
    shoulders_arms: [\
      \{ name: "D\'e9velopp\'e9 Militaire", sets: 4, reps: "10-12", rest: "90s", rpe: 8, note: "Base \'c9paules.", imageKeyword: "military press", instructions: "Barre ou halt\'e8res. Dos droit, abdos serr\'e9s. Poussez la charge au-dessus de la t\'eate sans cambrer.", \
        imageUrl: "" \},\
      \{ name: "\'c9l\'e9vations Lat\'e9rales Halt\'e8res", sets: 4, reps: "15-20", rest: "45s", rpe: 9, note: "Faisceau Lat\'e9ral.", imageKeyword: "lateral raise", instructions: "Coude l\'e9g\'e8rement fl\'e9chi. Montez les coudes, pas les mains. Contr\'f4lez la descente.", \
        imageUrl: "" \},\
      \{ name: "Curl Biceps Inclin\'e9", sets: 3, reps: "12", rest: "60s", rpe: 9, note: "Chef Long Biceps.", imageKeyword: "incline curl", instructions: "Banc \'e0 45\'b0. Laissez les bras pendre derri\'e8re le corps pour \'e9tirer le biceps. Gardez les coudes fixes.", \
        imageUrl: "" \},\
      \{ name: "Extension Triceps Corde", sets: 4, reps: "15", rest: "45s", rpe: 9, note: "Chef Lat\'e9ral Triceps.", imageKeyword: "tricep pushdown", instructions: "Poulie haute. \'c9cartez la corde en bas du mouvement. Gardez les coudes coll\'e9s aux c\'f4tes.", \
        imageUrl: "" \},\
      \{ name: "\'c9l\'e9vations Lat\'e9rales Poulie", sets: 3, reps: "15", rest: "45s", rpe: 9, note: "Tension continue.", imageKeyword: "cable lateral raise", instructions: "Poulie derri\'e8re le dos. Mouvement fluide, tension constante sur l'\'e9paule lat\'e9rale.", \
        imageUrl: "" \},\
      \{ name: "Barre au Front (Skullcrusher)", sets: 3, reps: "10-12", rest: "60s", rpe: 8, note: "Masse Triceps.", imageKeyword: "skullcrusher", instructions: "Allong\'e9. Descendez la barre vers le front (ou derri\'e8re la t\'eate). Gardez les coudes serr\'e9s.", \
        imageUrl: "" \},\
      \{ name: "Curl Altern\'e9 Halt\'e8res", sets: 3, reps: "12/bras", rest: "60s", rpe: 8, note: "Finition Biceps.", imageKeyword: "dumbbell curl", instructions: "Debout. Supination (tournez la paume vers le haut) en montant. Ne balancez pas le buste.", \
        imageUrl: "" \}\
    ],\
    chest_back: [\
      \{ name: "D\'e9velopp\'e9 Inclin\'e9", sets: 4, reps: "10", rest: "90s", rpe: 8, note: "Haut Pecs.", imageKeyword: "incline bench", instructions: "Banc \'e0 30\'b0. Cible le haut des pectoraux. Touchez la poitrine, poussez.", \
        imageUrl: "" \},\
      \{ name: "Tirage Horizontal", sets: 4, reps: "10", rest: "90s", rpe: 8, note: "Dos.", imageKeyword: "seated row", instructions: "Dos droit. Tirez la poign\'e9e au bas ventre. Sortez la poitrine.", \
        imageUrl: "" \},\
      \{ name: "T-Bar Row", sets: 3, reps: "12", rest: "90s", rpe: 9, note: "\'c9paisseur Dos.", imageKeyword: "t bar row", instructions: "Dos plat imp\'e9ratif. Tirez avec les coudes.", \
        imageUrl: "" \},\
      \{ name: "\'c9cart\'e9 Couch\'e9", sets: 3, reps: "15", rest: "60s", rpe: 9, note: "Isolation.", imageKeyword: "flyes", instructions: "Ouvrez la cage thoracique. Gardez une l\'e9g\'e8re flexion des coudes.", \
        imageUrl: "" \},\
      \{ name: "Pull-over", sets: 3, reps: "15", rest: "60s", rpe: 8, note: "Dos/Pecs.", imageKeyword: "pullover", instructions: "Allong\'e9 en travers du banc. Descendez l'halt\'e8re derri\'e8re la t\'eate bras tendus.", \
        imageUrl: "" \},\
      \{ name: "Shrugs", sets: 4, reps: "15", rest: "45s", rpe: 8, note: "Trap\'e8zes.", imageKeyword: "shrugs", instructions: "Haussement d'\'e9paules. Ne roulez pas les \'e9paules, juste haut/bas.", \
        imageUrl: "" \}\
    ]\
  \}\
\};\
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-slate-900/80 to-transparent flex items-end p-6 pointer-events-none">\
                <div>\
                    ...
                    <span className="text-white/60 text-xs font-medium uppercase tracking-wider drop-shadow-sm">\
                        \{exercise.sets.toString().includes('bloc') || exercise.sets.toString().includes('temps') ? exercise.sets : `$\{exercise.sets\} S\'e9ries`\} x \{exercise.reps\}\
                    </span>\
                </div>\
            </div>\
        ...
        <div className="p-6 space-y-6">\
            ...
            <div className="flex gap-4">\
                <div className="flex-1 bg-slate-50 p-3 rounded-2xl border border-slate-100 text-center">\
                    <div className="text-xs text-slate-400 font-bold uppercase">Repos / R\'e9cup</div>\
                ...
                <div className="flex-1 bg-rose-50 p-3 rounded-2xl border border-rose-100 text-center">\
                    <div className="text-xs text-rose-400 font-bold uppercase">Intensit\'e9</div>\
...
const PolarizationChart = (\{ low, high \}) => \{\
  ...
  if (total === 0) return <div className="text-xs text-slate-400 italic">Aucune donn\'e9e</div>;\
  ...
  return (\
    <div className="flex flex-col gap-2 w-full">\
      ...
      <div className="flex justify-between text-[10px] font-bold uppercase tracking-wider">\
        ...
        <span className="text-rose-600">Intensit\'e9 (\{highPercent\}%)</span>\
      </div>\
    </div>\
  );\
\};\
...
const InterferenceDiagram = () => (\
    <div className="relative h-40 bg-slate-50 rounded-xl border border-slate-100 p-4 flex items-center justify-center overflow-hidden mt-4">\
        ...
        <div className="absolute left-4 top-4 bottom-4 w-1/3 pr-4 flex flex-col justify-between items-end text-right z-10">\
            ...
            <div className="text-[9px] text-slate-400 bg-white/80 px-1 rounded">Stress M\'e9tabolique</div>\
            <div className="text-xs font-black text-white bg-indigo-500 px-2 py-1 rounded shadow-sm shadow-indigo-200">AMPk \uc0\u9889 </div>\
            <div className="text-[9px] text-indigo-400 font-bold italic">Biogen\'e8se Mito.</div>\
        </div>\
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex flex-col items-center bg-white/90 p-2 rounded-full border border-rose-100 shadow-sm">\
            <div className="bg-rose-500 text-white text-[9px] font-bold px-2 py-0.5 rounded-full mb-1">INTERF\'c9RENCE</div>\
            ...
            <div className="text-[8px] text-slate-400 text-center mt-1 leading-tight">Si s\'e9ances<br/>trop proches</div>\
        </div>\
        <div className="absolute right-4 top-4 bottom-4 w-1/3 pl-4 flex flex-col justify-between items-start z-10">\
            ...
            <div className="text-[9px] text-slate-400 bg-white/80 px-1 rounded">Tension M\'e9canique</div>\
            <div className="text-xs font-black text-white bg-rose-500 px-2 py-1 rounded shadow-sm shadow-rose-200">mTOR \uc0\u55358 \u56812 </div>\
            <div className="text-[9px] text-rose-400 font-bold italic">Synth\'e8se Prot\'e9ique</div>\
        </div>\
    </div>\
);\
\
...
const getRecommendedSchedule = (sessions) => \{\
    ...
    \
    // Initialisation : chaque jour est un tableau d'activit\'e9s\
    ...
    \}));\
\
    // --- 1. PLACEMENT DES RUNS (PRIORIT\'c9) ---\
    \
    // Dimanche : Longue\
    ...
    if (longRun) \{\
        ...
        scheduleData[6].focus = "Volume A\'e9robie";\
    \}\
\
    // Mardi : Qualit\'e9\
    ...
    if (qualityRun) \{\
        ...
        scheduleData[1].focus = "Intensit\'e9 Cl\'e9";\
    \}\
\
    // Jeudi : Endurance 1\
...
\
    ...
    if (easyRun2) \{\
        ...
        scheduleData[5].focus = "R\'e9cup Active";\
    \}\
\
    // --- 2. PLACEMENT DE LA MUSCU (COMBINAISON) ---\
\
    // Identification s\'e9ance jambes\
...
\
    ...
    if (legSession) \{\
        // Id\'e9al : Vendredi (Loin du Mardi, veille du Samedi r\'e9cup)\
        // Ou : Jeudi (Doubl\'e9 avec endurance)\
...
\
    ...
    \});\
    \
    // Si il reste des s\'e9ances muscu non plac\'e9es, on double les jours faciles\
...
\
    ...
    return scheduleData.map(day => \{\
        if (day.sessions.length === 0) return \{ day: day.dayName, activity: "Repos", focus: "R\'e9cup\'e9ration", sessionIds: [] \};\
        \
        ...
        return \{ \
            day: day.dayName, \
            activity: names, \
            focus: day.focus || "Entra\'eenement", \
            sessionIds: ids \
        \};\
    \});\
\};\
...
export default function App() \{\
  ...
  const loadState = (key, defaultValue) => \{\
    ...
    try \{\
        ...
        if (saved) \{\
            ...
            // Conversion sp\'e9ciale pour les Sets\
  ...
  \};\
\
  // NOUVEAU : Effet pour d\'e9finir l'ic\'f4ne de l'\'e9cran d'accueil iPhone\
  useEffect(() => \{\
    // Fonction pour injecter les ic\'f4nes (Apple + Favicon)\
    const updateIcons = () => \{\
      // Apple Touch Icon\
...
\
  ...
  \
  // Sauvegarde automatique \'e0 chaque changement\
  useEffect(() => \{\
    const dataToSave = \{\
        step,\
        activeTab,\
...
\
  ...
  \};\
\
  // NOUVEAU : Fonction pour cocher/d\'e9cocher un exercice individuel\
...
\
      if (action === 'easier') \{\
          ...
          message = "Plan adapt\'e9 : Allures ralenties de 5% pour la suite (r\'e9cup\'e9ration).";\
          type = 'warning';\
      \} else if (action === 'harder') \{\
          const newFactor = Math.max(0.8, userData.difficultyFactor - 0.05); \
          setUserData(prev => (\{ ...prev, difficultyFactor: newFactor \}));\
          message = "Plan adapt\'e9 : Allures acc\'e9l\'e9r\'e9es de 5% pour la suite (performance) !";\
          type = 'success';\
      \} else \{\
          message = "Semaine valid\'e9e ! Maintien de la progression pr\'e9vue.";\
          type = 'success';\
      \}\
...
\
    for (let i = 1; i <= totalWeeks; i++) \{\
      ...
      let sessions = [];\
      let focus = isRaceWeek ? "OBJECTIF" : isTaper ? "AFF\'dbTAGE" : isAdaptation ? "ADAPTATION" : "D\'c9VELOPPEMENT";\
      let volumeLabel = isAdaptation ? "Volume bas" : isTaper ? "R\'e9cup\'e9ration" : "Charge haute";\
      \
      ...
      sessions.push(\{\
        ...
        description: isTechWeek ? "40' cool + 5x80m progressif (lignes droites) pour la foul\'e9e." : "Aisance respiratoire stricte. Capacit\'e9 \'e0 parler.", \
        scienceNote: "Zone 1/2 : Densit\'e9 mitochondriale.",\
        planningAdvice: "Id\'e9al apr\'e8s une journ\'e9e de repos ou de muscu haut du corps.",\
        ...
        if (isAdaptation) \{\
           ...
           if (cycleType === 1) \{\
                ...
                sessions.push(\{\
                    ...
                    description: `20' \'e9cho + 10 x 30" vite / 30" lent + 10' cool.`, scienceNote: `Sollicitation VO2max et dynamique.`,\
                    planningAdvice: "S\'e9ance cl\'e9. Arrivez frais.",\
                    exercises: RUN_PROTOCOLS.interval_short\
                \});\
           \} else if (cycleType === 2) \{\
                sessions.push(\{\
                    id: `w$\{i\}-r2`, day: "RUN 2", category: 'run', type: "Renforcement C\'f4tes", structure: 'hills', intensity: 'high',\
                    duration: "40 min", durationMin: 40, distance: "Vari\'e9",\
                    paceTarget: "Effort", paceGap: 0, rpe: 8,\
                    description: `20' \'e9cho + 8 x 45" mont\'e9e dynamique (r\'e9cup descente).`, scienceNote: `Puissance musculaire sp\'e9cifique.`,\
           ...
           \} else \{\
                sessions.push(\{\
                    ...
                    duration: "45 min", durationMin: 45, distance: "Vari\'e9",\
                    paceTarget: paces.interval, paceGap: paces.gap, rpe: 7,\
                    description: `20' \'e9cho + 1'-2'-3'-2'-1' (r\'e9cup moiti\'e9 temps) + 10' cool.`, scienceNote: `Variation d'allure.`,\
                    planningAdvice: "S\'e9ance ludique.",\
                    exercises: RUN_PROTOCOLS.interval_short\
                \});\
           \}\
        \} else if (!isRaceWeek) \{\
           ...
           if (cycleType === 1) \{\
               ...
               sessions.push(\{\
                id: `w$\{i\}-r2`, day: "RUN 2", category: 'run', type: "Seuil Fractionn\'e9", structure: 'threshold', intensity: 'high',\
                duration: "1h00", durationMin: 60, distance: `~$\{distApprox.toFixed(1)\} km`,\
                paceTarget: paces.threshold, paceGap: paces.gap, rpe: 8,\
                description: `20' \'e9cho + 3 x 8min \'e0 $\{paces.threshold\}/km (r=2').`, scienceNote: `Cible : Seuil Ana\'e9robie.`,\
           ...
           \} else if (cycleType === 2) \{\
                sessions.push(\{\
                    ...
                    description: `15' \'e9cho + 20min continu \'e0 $\{paces.threshold\}/km + 15' cool.`, scienceNote: `Tenue de l'allure au mental.`,\
                    planningAdvice: "Focus rel\'e2chement.",\
                    exercises: RUN_PROTOCOLS.threshold\
                \});\
           \} else \{\
                sessions.push(\{\
                    id: `w$\{i\}-r2`, day: "RUN 2", category: 'run', type: "VMA Longue", structure: 'interval', intensity: 'high',\
                    duration: "55 min", durationMin: 55, distance: `Vari\'e9`,\
                    paceTarget: paces.interval, paceGap: paces.gap, rpe: 9,\
                    description: `20' \'e9cho + 5 x 3min (r=2' trot).`, scienceNote: `Soutien de VO2max.`,\
...
\
         sessions.push(\{\
            ...
            description: isFastFinish ? `Les $\{Math.min(15, longDur-30)\} derni\'e8res minutes \'e0 allure 10km. Le reste cool.` : `Endurance dur\'e9e. Restez dans la zone de confort.`, \
            scienceNote: isFastFinish ? "Pr\'e9-fatigue." : "R\'e9sistance \'e0 la fatigue centrale.",\
            planningAdvice: "Weekend. Mangez des glucides avant.",\
            exercises: RUN_PROTOCOLS.long_run\
          \});\
      \}\
\
      // --- RUN 4 (R\'e9cup - Si 4 runs) ---\
      if (userData.runDaysPerWeek >= 4 && !isRaceWeek) \{\
         sessions.push(\{\
            id: `w$\{i\}-r4`, day: "RUN 4", category: 'run', type: "Footing R\'e9cup\'e9ration", structure: 'steady', intensity: 'low',\
            duration: "40 min", durationMin: 40, distance: calcDist(40, paces.valEasy),\
            paceTarget: paces.easyRange, paceGap: paces.gap, rpe: 2,\
            description: "Footing tr\'e8s souple pour assimiler. Option v\'e9lo possible.", scienceNote: "R\'e9cup\'e9ration active.",\
            planningAdvice: "Le lendemain de la s\'e9ance dure.",\
...
\
      ...
      if (isRaceWeek) \{\
        sessions = [\
            \{ \
              id: `w$\{i\}-r1`, day: "J-3", category: 'run', type: "R\'e9veil Neuromusculaire", structure: 'interval', intensity: 'low', \
              duration: "20 min", durationMin: 20, distance: calcDist(20, paces.valEasy),\
              paceTarget: paces.easy, paceGap: 0, rpe: 3, description: "Tonus l\'e9ger.", scienceNote: "Potentiation post-activation (PAP).",\
              exercises: RUN_PROTOCOLS.steady\
            \},\
            \{ \
              id: `w$\{i\}-race`, day: "JOUR J", category: 'run', type: "COMP\'c9TITION", structure: 'steady', intensity: 'high', \
...
\
        if (userData.strengthFocus === 'force') \{\
            ...
            if (strengthCount === 2) \{\
                if(s===1) \{ gymType = "Jambes (Force)"; exercises = STRENGTH_PROTOCOLS.force.legs; gymTags=['legs']; gymAdvice = "\uc0\u9888 \u65039  \'c9vitez la veille du Run 2."; \}\
                else \{ gymType = "Haut du Corps"; exercises = STRENGTH_PROTOCOLS.force.upper; gymAdvice = "R\'e9cup\'e9ration active possible."; \}\
            \}\
        ...
        \} else \{\
            ...
            const splitNames = ["Push (Pecs/\'c9paules)", "Pull (Dos/Biceps)", "Legs (Jambes)", "Accessory (Bras/\'c9paules)", "Arnold (Pecs/Dos)"];\
            ...
            if (gymTags.includes('legs')) gymAdvice = "\uc0\u9888 \u65039  Attention : Grosse fatigue nerveuse.";\
            \
...
\
        sessions.push(\{\
          ...
          description: `S\'e9ance Volume ($\{gymType\}). 3 exos/muscle.`, \
...
\
  useEffect(() => \{\
      // Pour \'e9viter de re-g\'e9n\'e9rer en boucle au chargement, on ne lance generatePlan\
      // que si on est sur 'result' mais que le plan est vide (cas rare ou migration)\
      // Sinon c'est le bouton "Lancer" qui d\'e9clenche.\
  \}, [userData.difficultyFactor]);\
\
  const resetPlan = () => \{\
    if(confirm("Recommencer \'e0 z\'e9ro Charles ? Toutes les donn\'e9es seront effac\'e9es.")) \{\
        localStorage.removeItem('clab_storage'); // On efface la sauvegarde\
        setCompletedSessions(new Set());\
        setCompletedExercises(new Set()); // RAZ des exos coch\'e9s\
...
\
            <div className="max-w-3xl mx-auto px-6 relative z-10 text-center">\
                <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider mb-6 animate-in fade-in slide-in-from-top-4 duration-700">\
                    <GraduationCap size=\{14\} className="text-yellow-400"/> Ing\'e9nierie de la Performance\
                </div>\
                ...
                <p className="text-slate-300 text-lg md:text-xl max-w-xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-6 duration-1000">\
                    La science de l'entra\'eenement au service de votre 10km. <br/>\
                    <span className="text-sm opacity-75">Optimisation de l'interf\'e9rence Run/Muscu \'95 Planification Polaris\'e9e</span>\
                </p>\
...
\
              \{/* MODIFICATION : INPUT -> SELECT POUR LA DUR\'c9E */\}\
              <div className="space-y-4">\
                <label className="text-xs font-bold text-slate-400 uppercase">Dur\'e9e Pr\'e9pa</label>\
...
\
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">\
               <label className="flex justify-between text-xs font-bold text-slate-500 uppercase mb-4">\
                   <span>Progressivit\'e9 (Douceur de d\'e9part)</span>\
                ...
                <div className="space-y-3">\
                    ...
                    <div className="flex gap-4 bg-slate-50 p-1 rounded-xl border border-slate-200">\
                        <button onClick=\{() => setUserData(\{...userData, strengthFocus: 'force'\})\} className=\{`flex-1 py-3 rounded-lg text-sm font-bold flex flex-col items-center gap-1 transition $\{userData.strengthFocus === 'force' ? 'bg-white shadow-md text-rose-600 border border-rose-100' : 'text-slate-400 hover:bg-white/50'\}`\}>\
                            ...
                            <span className="text-[9px] font-normal opacity-70">5 reps \'95 Repos long \'95 Lourd</span>\
                        </button>\
                        <button onClick=\{() => setUserData(\{...userData, strengthFocus: 'hypertrophy'\})\} className=\{`flex-1 py-3 rounded-lg text-sm font-bold flex flex-col items-center gap-1 transition $\{userData.strengthFocus === 'hypertrophy' ? 'bg-white shadow-md text-indigo-600 border border-indigo-100' : 'text-slate-400 hover:bg-white/50'\}`\}>\
                            ...
                            <span className="text-[9px] font-normal opacity-70">12 reps \'95 Repos court \'95 Pump</span>\
                        </button>\
                    </div>\
                </div>\
            )\}\
          ...
          <div className="space-y-4 animate-in slide-in-from-right-4">\
            ...
            \{userData.difficultyFactor > 1 && (\
                <div className="bg-amber-50 border border-amber-200 p-4 rounded-xl flex items-start gap-3 animate-in fade-in">\
                    ...
                    <div>\
                        <h4 className="font-bold text-amber-800 text-sm">Mode Adapt\'e9 Activ\'e9</h4>\
                        <p className="text-xs text-amber-700 mt-1">Le plan a \'e9t\'e9 ralenti de \{Math.round((userData.difficultyFactor - 1)*100)\}% suite \'e0 votre feedback. Les allures sont plus douces pour favoriser la r\'e9cup\'e9ration.</p>\
                    </div>\
                </div>\
            )\}\
            \
...
\
            \{plan.map((week) => \{\
                ...
                \
                // V\'e9rifier si TOUTES les s\'e9ances de la semaine sont compl\'e9t\'e9es\
...
\
                ...
                const sessionsToShow = filteredSessionIds \
                    ...
                    : week.sessions;\
\
                // Indicateur visuel pour l'en-t\'eate de semaine (Vert si fini)\
                    ...
                    <button onClick=\{() => setExpandedWeek(isOpen ? null : week.weekNumber)\} className=\{`w-full p-4 flex items-center justify-between $\{headerBgClass\}`\}>\
                      <div className="flex items-center gap-3">\
                        ...
                        <div className="text-left">\
                            ...
                            \{allSessionsCompleted && <span className="text-[10px] text-green-600 font-medium">Semaine valid\'e9e</span>\}\
                        </div>\
                      </div>\
                            ...
                            <div className="mx-1 mb-4 border-2 border-slate-100 rounded-xl overflow-hidden bg-slate-50/50">\
                                <div className="bg-slate-100 px-4 py-2 flex items-center justify-between border-b border-slate-200">\
                                    <div className="flex items-center gap-2">\
                                        ...
                                        <h4 className="text-xs font-bold text-slate-600 uppercase tracking-wide">Planning Id\'e9al Sugg\'e9r\'e9 (Cliquable)</h4>\
                                    </div>\
                                    \{filteredSessionIds && (\
                                ...
                                <div className="p-3 grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">\
                                    \{week.schedule.map((day, i) => \{\
                                       ...
                                       \
                                        // V\'e9rifier si ce jour est enti\'e8rement compl\'e9t\'e9\
...
\
                                ...
                                <div className="px-4 py-2 bg-indigo-50 text-[10px] text-indigo-700 border-t border-indigo-100 flex items-center gap-2">\
                                    <Info size=\{12\}/>\
                                    Ce planning s\'e9pare optimalement la force (Jambes) des s\'e9ances intenses (VMA/Seuil).\
                                </div>\
                            </div>\
                        )\}\
\
...
\
                                    ...
                                    \{session.exercises && !isDone && (\
                                        <div className="mt-2 text-center text-[10px] text-slate-400 font-medium">\
                                            \{isExpandedSession ? "Masquer d\'e9tails" : "Voir d\'e9tails s\'e9ance \uc0\u9660 "\}\
                                        </div>\
                                    )\}\
                                </div>\
\
...
\
                                                            <div className="flex-1 flex justify-between items-center cursor-help" onClick=\{() => setModalExercise(exo)\}>\
                                                                <div className="flex items-center gap-2">\
                                                                    ...
                                                                    <div className=\{isChecked ? 'opacity-50' : ''\}>\
                                                                        ...
                                                                        <div className="text-[10px] text-slate-500">\{exo.sets.toString().includes('min') || exo.sets.toString().includes('bloc') ? exo.sets : `$\{exo.sets\} s\'e9ries`\} \'95 \{exo.reps.includes('reps') ? exo.reps : `$\{exo.reps\}`\} \{exo.rest !== '-' ? `\'95 R: $\{exo.rest\}` : ''\}</div>\
                                                                    </div>\
                                                                </div>\
                                            ...
                                            <button onClick=\{() => toggleSession(session.id)\} className="mt-3 w-full py-2 bg-green-500 text-white rounded font-bold text-xs flex items-center justify-center gap-1">\
                                                <CheckCircle size=\{12\} /> Valider la s\'e9ance\
                                            </button>\
                                    </div>\
                                )\}\
\
                            ...
                            <div className="p-8 text-center text-slate-400 text-xs italic animate-in fade-in">\
                                Aucune s\'e9ance pr\'e9vue ce jour-l\'e0. Repos ! \uc0\u55357 \u56484 \
                            </div>\
                        )\}\
                      </div>\
                    )\}\
                    ...
                    \{isOpen && allSessionsCompleted && (\
                        <div className="p-4 border-t border-green-100 bg-green-50 flex flex-col gap-3 animate-in slide-in-from-bottom-2">\
                            <div className="flex items-center gap-2 text-green-800 text-sm font-bold">\
                                <Award size=\{18\}/> Semaine Termin\'e9e ! Bilan ?\
                            </div>\
                            <div className="flex gap-2">\
             ...
             \
              <div className="grid grid-cols-3 gap-4 mb-8">\
                ...
                <div className="text-center p-3 bg-slate-50 rounded-xl">\
                  ...
                  <div className="text-[10px] font-bold text-slate-400 uppercase">S\'e9ances</div>\
                </div>\
              </div>\
\
              <div className="space-y-8">\
                <div>\
                  <h4 className="text-xs font-bold text-slate-500 uppercase mb-2">Respect du mod\'e8le Polaris\'e9 (80/20)</h4>\
                  <PolarizationChart \
             ...
             <div className="space-y-4 relative z-10">\
               <div className="bg-white/10 backdrop-blur border border-white/10 p-4 rounded-xl">\
                 <div className="flex items-start gap-3">\
                   ...
                   <div>\
                     <h4 className="font-bold text-sm">Entra\'eenement Polaris\'e9</h4>\
                     <p className="text-xs text-slate-300 mt-1 leading-relaxed">\
                       Votre plan suit la distribution des intensit\'e9s de <strong>Stephen Seiler (2010)</strong>. 80% du volume est effectu\'e9 \'e0 basse intensit\'e9 (Zone 1/2) pour maximiser la densit\'e9 mitochondriale sans fatigue excessive.\
                     </p>\
                   </div>\
                 </div>\
               </div>\
               ...
               <div className="bg-white/10 backdrop-blur border border-white/10 p-4 rounded-xl">\
                 <div className="flex items-start gap-3">\
                   ...
                   <div>\
                     ...
                     <p className="text-xs text-slate-300 mt-1 leading-relaxed">\
                       Nous utilisons l'\'e9chelle <strong>Borg CR-10</strong> modifi\'e9e par Foster pour quantifier la charge interne. C'est souvent plus fiable que la fr\'e9quence cardiaque seule.\
                     </p>\
                   </div>\
                 </div>\
               </div>\
\
               \{userData.strengthDaysPerWeek > 0 && (\
                 <div className="bg-white/10 backdrop-blur border border-white/10 p-4 rounded-xl">\
                    <div className="flex items-start gap-3">\
                      ...
                      <div>\
                        <h4 className="font-bold text-sm">Effet d'Interf\'e9rence</h4>\
                        <p className="text-xs text-slate-300 mt-1 leading-relaxed">\
                          Pour \'e9viter que la muscu ne nuise au run, les s\'e9ances "Jambes" sont plac\'e9es de mani\'e8re strat\'e9gique (\'e9loign\'e9es des s\'e9ances VMA) selon <strong>Murach & Bagley (2016)</strong>.\
                        </p>\
                      </div>\
                    </div>\
                  </div>\
               ...
               <div className="bg-white/10 backdrop-blur border border-white/10 p-4 rounded-xl">\
                 <div className="flex items-start gap-3">\
                   ...
                   <div>\
                     <h4 className="font-bold text-sm">Mod\'e8le de Banister</h4>\
                     <BanisterChart duration=\{userData.durationWeeks\} />\
                     <p className="text-[10px] text-slate-300 mt-2 leading-relaxed italic">\
                       Mod\'e9lisation th\'e9orique de la performance (Forme = Fitness - Fatigue). Notez le pic de forme pr\'e9vu \'e0 la fin gr\'e2ce \'e0 l'aff\'fbtage.\
                     </p>\
                   </div>\
                 </div>\
               </div>\
               ...
               \{userData.strengthDaysPerWeek > 0 && (\
                   <div className="bg-white/10 backdrop-blur border border-white/10 p-4 rounded-xl">\
                     <div className="flex items-start gap-3">\
                       ...
                       <div>\
                         <h4 className="font-bold text-sm">M\'e9canismes Mol\'e9culaires</h4>\
                         <InterferenceDiagram />\
                         <p className="text-[10px] text-slate-300 mt-2 leading-relaxed italic">\
                           Sch\'e9matisation du conflit potentiel entre les voies de signalisation AMPk (endurance) et mTOR (hypertrophie).\
                         </p>\
                       </div>\
                     </div>\
                   </div>\
...
\
      ...
      \{step === 'result' && (\
        <footer className="py-8 text-center border-t border-slate-200 mt-12 bg-white/50 backdrop-blur-sm">\
            <p className="text-slate-500 font-medium text-sm">Cr\'e9\'e9 par <span className="bg-gradient-to-r from-indigo-600 to-rose-500 bg-clip-text text-transparent font-black">Charles Viennot</span></p>\
            <p className="text-slate-400 text-xs mt-1 uppercase tracking-widest flex items-center justify-center gap-2"><GraduationCap size=\{12\} /> \'c9tudiant en Ing\'e9nierie du Sport</p>\
            <button onClick=\{resetPlan\} className="mt-4 text-[10px] text-slate-300 hover:text-rose-400 flex items-center justify-center gap-1 w-full transition-colors"><RotateCcw size=\{10\}/> R\'e9initialiser les donn\'e9es</button>\
        </footer>\
      )\}\
      </div>\
    </div>\
